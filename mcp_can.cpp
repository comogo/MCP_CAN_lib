...
{
    mcpSPI->beginTransaction(SPISettings(m_SPISpeed, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
** Descriptions:            Public function to set the SPI speed.
*********************************************************************************************************/
void MCP_CAN::setSPISpeed(INT32U speed)
{
    m_SPISpeed = speed;
}
